...
export default function Page() {
    return (
        <main className='mt-[320px] flex flex-col items-center mx-5 md:mt-[200px] md:mx-0'>
            ...
            <div className=' flex flex-col gap-10 w-auto md:w-[80rem]'>
                ...
                >
                    ...
                    <div className='flex flex-col gap-5'>
                        <h1 className='text-white font-bold text-2xl md:text-3xl'>About ads</h1>
                        <p className='text-xl font-semibold text-gray-500'>Shonenhub does not contain ads.</p>

                    </div>

                    <div className='flex flex-col gap-5'>
                        <h1 className='text-white font-bold text-2xl md:text-3xl'>Is Shonenhub safe ?</h1>
                    ...
                    <div className='flex flex-col gap-5'>
                        <h1 className='text-white font-bold text-2xl md:text-3xl'>Is it legal to use Shonenhub ?</h1>
                        <p className='text-xl font-semibold text-gray-500'>
