    ...
    <>
      {searchedAnime.error === true ? (
        ...
        <div className=" mt-[100px] flex flex-col items-center gap-5">
          ...
          <p className=" text-center h-[30rem] text-orange-700 font-bold text-3xl">
            Loading...
          </p>
        </div>
      ) : (
        <div className="flex flex-col mt-[340px] items-center gap-5 md:mt-[150px]">
          <div className=" flex flex-col gap-3">
            <h1 className="text-2xl text-violet-700 font-bold md:text-4xl">
              Search results for{" "}
              <span className=" uppercase font-extrabold">{animeName}</span>
            </h1>
          ...
          {searchedAnime.data.length > 0 ? (
            <div className="w-auto mt-[50px] flex flex-wrap gap-5 justify-center md:w-[70rem]">
              {searchedAnime.data &&
                Array.isArray(searchedAnime.data) &&
            ...
            <p className=" text-white mt-10 text-2xl font-bold md:text-4xl md:h-[15rem]">
