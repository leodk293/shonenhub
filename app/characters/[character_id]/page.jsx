  ...
  return (
    <div className="mt-[300px] mx-5 md:mx-0 md:mt-[180px]">
      ...
      {character.error === true ? (
        <p className=" text-center text-2xl mt-2 font-bold text-red-700">
        ...
        character.data && (
          <div className=" flex flex-col items-center">
            <div className=" flex flex-col gap-4">
              <h1 className=" font-bold text-white w-auto text-2xl md:text-3xl md:w-[45rem]">
                {character.data.name}
              </h1>
              <p className="text-white font-semibold text-[17px] md:text-xl">
                Character of
                <Link
            ...
            <div className=" mt-10 flex flex-col border border-slate-900 bg-[#0000005c] p-10 rounded-[10px] gap-5 items-center">
              <div className=" w-auto md:w-[50rem]"></div>
