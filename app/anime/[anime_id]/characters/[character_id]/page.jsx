  ...
  async function fetchCharacterData() {
    ...
    try {
      const response = await fetch(
        `https://api.jikan.moe/v4/characters/${params.character_id}/full`
      );
      if (!response.ok) {
    ...
    <>
      ...
      <div className="mt-[290px] mx-5 md:mx-0 md:mt-[180px]">
        {characterData.error === true ? (
          <p className=" text-center text-red-700 h-[20rem] text-3xl">
          ...
          characterData.data && (
            <div className="flex flex-col items-center">
              ...
              <div className="flex flex-col mt-10 gap-5 items-center">
                <h1 className="text-center text-blue-900 font-extrabold text-5xl">
                  Voice Actors
                </h1>
                <div className="flex flex-wrap justify-center gap-5">
                  {characterData.data.voices.slice(0, 5).map((actor) => (
                    <div
                      ...
                      className="flex flex-col border border-slate-700 bg-slate-950 p-3 rounded-[5px] gap-2"
                    >
                      <img
                      ...
                      />
                      <p className="text-white w-[150px] text-xl">
                        {actor.person.name}
                      </p>
